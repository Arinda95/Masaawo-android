...
public class MainActivityAboutUs extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_activity_about_us);
        ...
        WebView About = (WebView)findViewById(R.id.aboutWebView);
